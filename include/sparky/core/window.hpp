...
#ifndef _SPARKY_WINDOW_HPP_
#define _SPARKY_WINDOW_HPP_
...
// Sparky includes
//====================
#include <sparky/utilities/non_copyable.hpp> // Window is a non-copyable object.
#include <sparky/core/context.hpp>           // The context settings for the Window.
#include <sparky/utilities/logger.hpp>       // Logging messages with the state of the window.
