...
#ifndef _SPARKY_LOGGER_FACTORY_HPP_
#define _SPARKY_LOGGER_FACTORY_HPP_

//==================== 
// C++ includes
//====================  
#include <sparky/utilities/factory.hpp> // Factory for creating and storing different Logger objects.
#include <sparky/utilities/logger.hpp>  // Storing logger objects.
...
#endif//_SPARKY_LOGGER_FACTORy_HPP_