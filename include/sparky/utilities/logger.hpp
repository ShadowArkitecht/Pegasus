...
#ifndef _SPARKY_LOGGER_HPP_
#define _SPARKY_LOGGER_HPP_
...
// Sparky includes
//====================
#include <sparky/utilities/ipolicy.hpp> // Policy used for print the contents of the logs to different contents.
