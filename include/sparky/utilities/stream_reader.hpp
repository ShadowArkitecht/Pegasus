...
#ifndef _SPARKY_STREAM_READER_HPP_
#define _SPARKY_STREAM_READER_HPP_
...
// Sparky includes
//==================== 
#include <sparky/utilities/reader.hpp> // StreamReader inherits from the Reader object.
...
#endif//_SPARKY_STREAM_READER_HPP_
