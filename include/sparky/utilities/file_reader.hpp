...
#ifndef _SPARKY_FILE_READER_HPP_
#define _SPARKY_FILE_READER_HPP_

//==================== 
// Sparky includes
//==================== 
#include <sparky/utilities/reader.hpp>
...
namespace sparky
{
	 ...
	 * 
	 * @class sparky::FileReader
	 * @ingroup utilities
	 * 
	 * @brief IO class responsible for loading and storing the entire contents of an external file.
	 * 
	 * The FileReader class is one of the child Reader classes supported within the Sparky Engine. The file
...
#endif//_SPARKY_FILE_READER_HPP_