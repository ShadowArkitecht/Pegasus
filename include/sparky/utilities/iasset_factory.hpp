...
#ifndef _SPARKY_IASSET_FACTORY_HPP_
#define _SPARKY_IASSET_FACTORY_HPP_
...
namespace sparky
{
	 ...
	 * 
	 * @class sparky::IAssetFactory
	 * @ingroup utilities
	 * 
	 * @brief Base abstract class for all resource-related factories.
	 * 
	 * The IAssetFactory class is the parent class for factories relating to asset management within the Sparky
...
#endif//_SPARKY_IASSET_FACTORY_HPP_
