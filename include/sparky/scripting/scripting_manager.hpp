...
#ifndef _SPARKY_SCRIPTING_MANAGER_HPP_
#define _SPARKY_SCRIPTING_MANAGER_HPP_

//====================
// Sparky includes
//====================
#include <sparky/utilities/singleton.hpp> // The scripting manager is a type of singleton.
...
namespace sparky
{
	...
	public:
		 ...
		 * that the Sparky Engine can utilise.
		 *
...
#endif//_SPARKY_SCRIPTING_MANAGER_HPP_