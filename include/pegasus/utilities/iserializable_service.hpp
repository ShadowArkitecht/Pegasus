#ifndef _PEGASUS_ISERIALIZABlE_SERVICE_HPP_
#define _PEGASUS_ISERIALIZABlE_SERVICE_HPP_
...
namespace pegasus
{
     ...
     *
     * @class pegasus::ISerializableService
     * @ingroup utilities
     *
     ...
     * serialized file formats into a asset class that can be utilised by the pegasus engine.
     *
    ...
    */
    ...
    public:
         ...
         * specified asset so that it can be used within the pegasus engine.
         *
		 ...
		 * format that the pegasus engine can utilise.
		 * 
...
#endif//_PEGASUS_ISERIALIZABlE_SERVICE_HPP_
