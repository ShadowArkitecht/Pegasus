...
#ifndef _PEGASUS_SINGLETON_HPP_
#define _PEGASUS_SINGLETON_HPP_

//==================== 
// Pegasus includes
//==================== 
#include <pegasus/utilities/non_copyable.hpp> // Singleton is a non-copyable object.
